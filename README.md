This is a clone of Jay Carlsons repo for a simple project using the PUYA PY32Fxxxx devices. I've removed some of the tests he used and altered it to suit my device which is the py32f003x8. It's also updated for a linux build system and debugging using gdb-multiarch and jlink debugger. I've left the orginal repo readme attached below. Thumbs up to Jay for his work here. This gave me the initial grounding from which I then was able to work the rest out. Some of the lib sources have been altered slightly to build correctly as there was some minor build problems when moving from the py32f00a to the py32f003.

Jays repo can be found here https://github.com/jaydcarlson
Jays excellent website can be sound here https://jaycarlson.net
Jays PUYA specific page is here https://jaycarlson.net/2023/02/04/the-cheapest-flash-microcontroller-you-can-buy-is-actually-an-arm-cortex-m0/
